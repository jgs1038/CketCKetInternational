...
public class CompraEntradasNickiPrecioIN extends AppCompatActivity{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.compra_entradas_nicki_precio_in);
    }
    ...
    public void AnadirAsiento(View view) {
