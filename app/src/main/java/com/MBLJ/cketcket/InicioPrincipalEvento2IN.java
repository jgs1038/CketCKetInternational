...
public class InicioPrincipalEvento2IN extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.principal_inicio_evento2_in);
    }
    ...
    public void SiguienteEventoACDC(View view){
        Intent siguienteACDC = new Intent (this, PerfilEventoDuneIN.class);
        startActivity(siguienteACDC);
    }
    public void SiguienteArtista(View view){
        Intent siguienteACDC = new Intent (this, InicioPrincipal4IN.class);
        startActivity(siguienteACDC);
    }
    public void SiguienteEvento(View view){
        Intent siguienteACDC = new Intent (this, InicioPrincipalEvento3IN.class);
        startActivity(siguienteACDC);
    }
    public void AnteriorEvento(View view){
        Intent siguienteACDC = new Intent (this, InicioPrincipalEventoIN.class);
        startActivity(siguienteACDC);
    }
