...
public class InicioPrincipal2IN extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.principal_inicio2_in);
    }
    ...
    public void SiguienteEvento(View view){
        Intent siguienteACDC = new Intent (this, InicioPrincipal3IN.class);
        startActivity(siguienteACDC);
    }
