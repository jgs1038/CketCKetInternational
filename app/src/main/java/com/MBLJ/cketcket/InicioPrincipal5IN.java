...
public class InicioPrincipal5IN extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.principal_inicio5_in);
    }
    ...
    public void SiguienteACDC(View view){
        Intent siguienteNicki = new Intent (this, PerfilArtistaACDCIN.class);
