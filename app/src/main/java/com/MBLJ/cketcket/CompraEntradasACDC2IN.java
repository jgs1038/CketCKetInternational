...
public class CompraEntradasACDC2IN extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.compra_entradas_2_in);
    }
    ...
    public void SiguienteCompra3(View view) {
        Intent siguiente = new Intent(this, CompraEntradasACDC3IN.class);
        startActivity(siguiente);
    }
}