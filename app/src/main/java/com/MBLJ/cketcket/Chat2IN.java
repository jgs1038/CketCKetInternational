...
public class Chat2IN extends AppCompatActivity  {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.chat2_in);
    }
    ...
    public void BuscarUsuario(View view) {
        Intent siguiente = new Intent(this, BusquedaUsuarioIN.class);
        startActivity(siguiente);
    }
    public void EntradasCompradas(View view) {
        Intent siguiente = new Intent(this, EntradasCompradasIN.class);
        startActivity(siguiente);
    }
    public void EntradasVendidas(View view) {
        Intent siguiente = new Intent(this, EntradasVendidasIN.class);
        startActivity(siguiente);
    }
