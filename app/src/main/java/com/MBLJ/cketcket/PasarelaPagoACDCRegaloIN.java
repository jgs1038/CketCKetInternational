...
public class PasarelaPagoACDCRegaloIN extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pasarela_pago_acdc_regalo_in);
    }
    ...
    public void SiguientePagoTarjeta(View view) {
        Intent siguiente = new Intent(this, PasarelaPagoACDCTarjetaIN.class);
        startActivity(siguiente);
    }
}