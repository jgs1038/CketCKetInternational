...
public class BusquedaAvanzadaIN extends AppCompatActivity  {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.busqueda_avanzada_in);
    }
    ...
    public void Evento(View view) {
        Intent siguiente = new Intent(this, BusquedaAvanzadaEventoIN.class);
        startActivity(siguiente);
    }
    public void Merchandising(View view) {
        Intent siguiente = new Intent(this, BusquedaAvanzadaMerchandisingIN.class);
        startActivity(siguiente);
    }
