...
public class CompraEntradasNickiPrecio2_2IN extends AppCompatActivity{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.compra_entradas_nicki_precio2_2_in);
    }
    ...
    public void SiguienteMayorMenor(View view) {
        Intent siguiente = new Intent(this, CompraEntradasNickiPrecio1_2IN.class);
        startActivity(siguiente);
    }
    public void AnteriorPrecios(View view) {
        Intent siguiente = new Intent(this, CompraEntradasNickiPrecio2IN.class);
        startActivity(siguiente);
    }

    public void PasarelaPago(View view) {
        Intent siguiente = new Intent(this, PasarelaPagoNNIN.class);
        startActivity(siguiente);
    }
}
