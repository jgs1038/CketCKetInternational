...
public class PasarelaPagoNNContrareembolsoIN extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pasarela_pago_nn_contrareembolso_in);
    }
    ...
    public void SiguienteConfirmacionNNGmail(View view) {
        Intent siguiente = new Intent(this, PasarelaPagoNNTarjeta2IN.class);
        startActivity(siguiente);
    }
}