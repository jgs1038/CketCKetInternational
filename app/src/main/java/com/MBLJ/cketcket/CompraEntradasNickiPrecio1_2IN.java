...
public class CompraEntradasNickiPrecio1_2IN extends AppCompatActivity{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.compra_entradas_nicki_precio1_2_in);
    }
    ...
    public void SiguienteMayorMenor(View view) {
        Intent siguiente = new Intent(this, CompraEntradasNickiPrecio2_2IN.class);
        startActivity(siguiente);
    }
