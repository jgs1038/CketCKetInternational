...
public class PerfilUsuarioIN extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.perfil_usuario_in);
    }
    ...
    public void Chat(View view){
        Intent siguiente = new Intent (this, ChatIN.class);
        startActivity(siguiente);
    }

    public void Bloqueado(View view){
        Intent siguiente = new Intent (this, BloqueadoIN.class);
        startActivity(siguiente);
    }

    public void SiguienteChiara(View view){
        Intent siguiente = new Intent (this, PerfilArtistaKikiIN.class);
        startActivity(siguiente);
    }
    public void SiguienteNicki(View view){
        Intent siguiente = new Intent (this, PerfilArtistaNickiIN.class);
        startActivity(siguiente);
    }
    public void SiguienteACDC(View view){
        Intent siguiente = new Intent (this, PerfilArtistaACDCIN.class);
        startActivity(siguiente);
    }
