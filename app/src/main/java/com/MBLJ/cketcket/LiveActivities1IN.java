...
public class LiveActivities1IN extends AppCompatActivity  {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.live_activities1_in);
    }
    ...
    public void Directo(View view) {
        Intent siguiente = new Intent(this, EmpezarDirectoIN.class);
        startActivity(siguiente);
    }
    public void Encuesta(View view) {
        Intent siguiente = new Intent(this, CrearEncuestaIN.class);
        startActivity(siguiente);
    }
    public void PreguntasRespuestas(View view) {
        Intent siguiente = new Intent(this, PreguntasRespuestasIN.class);
        startActivity(siguiente);
    }
    public void Historia(View view) {
        Intent siguiente = new Intent(this, AnadirHistoriaIN.class);
        startActivity(siguiente);
    }
