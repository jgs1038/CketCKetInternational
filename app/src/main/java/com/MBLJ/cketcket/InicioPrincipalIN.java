...
public class InicioPrincipalIN extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.principal_inicio_in);
    }
    ...
    public void SiguienteEventoACDC(View view){
        Intent siguienteACDC = new Intent (this, PerfilEventoACDCIN.class);
        startActivity(siguienteACDC);
    }

    public void SiguienteArtista(View view){
        Intent siguienteACDC = new Intent (this, InicioPrincipal2IN.class);
        startActivity(siguienteACDC);
    }
