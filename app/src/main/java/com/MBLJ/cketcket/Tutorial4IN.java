...
public class Tutorial4IN extends AppCompatActivity  {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tutorial4_in);
    ...
    public void Paso6_1(View view) {
        Intent siguiente = new Intent(this, Tutorial5IN.class);
        startActivity(siguiente);
    }
}
