...
public class MisPuntosAdministradorIN extends AppCompatActivity  {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.mis_puntos_administrador_in);
    }
    ...
    public void Canjear(View view){
        Intent siguiente = new Intent (this, TiendaPuntosIN.class);
        startActivity(siguiente);
    }
