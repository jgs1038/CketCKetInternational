...
public class CeAcdcF2V22IN extends AppCompatActivity{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ceacdcf2v22_in);
    }
    ...
    public void SiguienteElegirAsientos(View view) {
        Intent siguiente = new Intent(this, CompraEntradasACDCIN.class);
        startActivity(siguiente);
    }
    public void SiguienteMenorMayor(View view) {
        Intent siguiente = new Intent(this, CeAcdcF22IN.class);
        startActivity(siguiente);
    }

    public void AnteriorCompra(View view) {
        Intent siguiente = new Intent(this, CeAcdcF2V2IN.class);
        startActivity(siguiente);
    }
