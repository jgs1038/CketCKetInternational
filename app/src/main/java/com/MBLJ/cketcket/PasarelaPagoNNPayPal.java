...
public class PasarelaPagoNNPayPal extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pasarela_pago_nn_paypal);
    }
    ...
    public void SiguienteNNFin(View view) {
        Intent siguiente = new Intent(this, PasarelaPagoNNFin.class);
        startActivity(siguiente);
    }
}