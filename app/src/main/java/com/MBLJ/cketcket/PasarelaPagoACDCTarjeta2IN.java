...
public class PasarelaPagoACDCTarjeta2IN extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pasarela_pago_acdc_tarjeta2_in);
    }
    ...
    public void SiguienteFin(View view) {
        Intent siguiente = new Intent(this, PasarelaPagoACDCFinIN.class);
        startActivity(siguiente);
    }
}