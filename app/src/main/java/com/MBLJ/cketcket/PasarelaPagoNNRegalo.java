...
public class PasarelaPagoNNRegalo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pasarela_pago_nn_regalo);
    }
    ...
    public void SiguientePagoNNTarjeta(View view) {
        Intent siguiente = new Intent(this, PasarelaPagoNNTarjeta.class);
        startActivity(siguiente);
    }
}