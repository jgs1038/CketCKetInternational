...
public class PasarelaPagoNNRegaloIN extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pasarela_pago_nn_regalo_in);
    }
    ...
    public void SiguientePagoNNTarjeta(View view) {
        Intent siguiente = new Intent(this, PasarelaPagoNNTarjetaIN.class);
        startActivity(siguiente);
    }
}