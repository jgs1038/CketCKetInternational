...
public class LiveActivitiesIN extends AppCompatActivity  {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.live_activities_in);
    }
    ...
    public void LiveActivities(View view) {
        Intent siguiente = new Intent(this, LiveActivities1IN.class);
        startActivity(siguiente);
    }
}
