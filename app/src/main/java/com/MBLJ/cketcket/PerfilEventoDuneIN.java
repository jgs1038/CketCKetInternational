...
public class PerfilEventoDuneIN extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.perfil_evento_dune_in);
    }
    ...
    public void SiguienteError2(View view){
        Intent siguiente = new Intent (this, Error404IN.class);
        startActivity(siguiente);
    }
}
