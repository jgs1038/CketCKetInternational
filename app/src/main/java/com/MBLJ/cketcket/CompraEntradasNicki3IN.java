...
public class CompraEntradasNicki3IN extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.compra_entradas_nicki_3_in);
    }
    ...
    public void AnteriorCompra(View view) {
        Intent siguiente = new Intent(this, CompraEntradasNicki2IN.class);
        startActivity(siguiente);
    }
