...
public class Tutorial1IN extends AppCompatActivity  {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tutorial1_in);
    ...
    public void Paso3_1(View view) {
        Intent siguiente = new Intent(this, Tutorial2IN.class);
        startActivity(siguiente);
    }
}
