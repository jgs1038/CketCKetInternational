...
public class PasarelaPagoNNTarjetaIN extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pasarela_pago_nn_tarjeta_in);
        ...
        myButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(PasarelaPagoNNTarjetaIN.this, "The established amount of money will be retired from the credit card", Toast.LENGTH_SHORT).show();

                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(PasarelaPagoNNTarjetaIN.this, PasarelaPagoNNTarjeta2IN.class);
