...
public class CompraEntradasNicki2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.compra_entradas_nicki_2);
    }
    ...
    public void SiguienteCompra3(View view) {
        Intent siguiente = new Intent(this, CompraEntradasNicki3.class);
        startActivity(siguiente);
    }
}