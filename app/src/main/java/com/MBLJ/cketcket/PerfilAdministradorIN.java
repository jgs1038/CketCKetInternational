...
public class PerfilAdministradorIN extends AppCompatActivity  {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.perfil_administrador_in);
    }
    ...
    public void EventoTeatro(View view){
        Intent evento = new Intent (this, PerfilEventoTeatroIN.class);
        startActivity(evento);
    }

    public void EventoFutbol(View view){
        Intent evento = new Intent (this, PerfilEventoBLIN.class);
        startActivity(evento);
    }
}
