...
public class PasarelaPagoACDCTarjetaIN extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pasarela_pago_acdc_tarjeta_in);
        ...
        myButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(PasarelaPagoACDCTarjetaIN.this, "The established amount of money will be retired from the credit card", Toast.LENGTH_SHORT).show();

                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(PasarelaPagoACDCTarjetaIN.this, PasarelaPagoACDCTarjeta2IN.class);
