...
public class PasarelaPagoACDCContrareembolsoIN extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pasarela_pago_acdc_contrareembolso_in);
    }
    ...
    public void SiguienteConfirmacionGmail(View view) {
        Intent siguiente = new Intent(this, PasarelaPagoACDCTarjeta2IN.class);
        startActivity(siguiente);
    }
}