...
public class PerfilOrganizadorIN extends AppCompatActivity  {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.perfil_organizador_in);
    }
    ...
    public void perfilNicki(View view){
        Intent evento = new Intent (this, PerfilArtistaNickiIN.class);
        startActivity(evento);
    }
    public void perfilACDC(View view){
        Intent evento = new Intent (this, PerfilArtistaACDCIN.class);
        startActivity(evento);
    }
}
